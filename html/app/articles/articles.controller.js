...
angular.module('myApp').controller('ArticlesController', ["Articles", "Categories", "$routeParams", "Flash", function ArticlesController(Articles, Categories, $routeParams, Flash) {
    var vm = this;

...
angular.module('myApp').controller('ArticlesController', ["Articles", "Categories", "$routeParams", "Flash", "currentAuth", function LoginController(Articles, Categories, $routeParams, Flash, currentAuth) {
    var vm = this;
